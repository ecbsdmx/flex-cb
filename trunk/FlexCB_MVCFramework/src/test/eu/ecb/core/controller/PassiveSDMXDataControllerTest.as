package eu.ecb.core.controller
{
	...
	public class PassiveSDMXDataControllerTest 
		extends BaseSDMXServiceControllerTest
	{
		private var _testDataSet:DataSet;
		
		private var _compactReader:CompactReader;
		
		public function PassiveSDMXDataControllerTest()
		{
			super();
		}
		...
		{
			return new TestSuite(PassiveSDMXDataControllerTest);
		}
		
		override public function createController():IController 
		{
			_model = new SDMXDataModel();
			return new PassiveSDMXDataController(_model 
				as ISDMXDataModel);
		}
		...
		private function handleDataSet(event:SDMXDataEvent):void
		{
			...
			_model.addEventListener(BaseSDMXServiceModel.DATA_SET_UPDATED, 
				handleDS1);
			(_controller as PassiveSDMXDataController).dataSet = _testDataSet;
		}
		...
		private function handleDS1(event:Event):void
		{
			...
			(_controller as PassiveSDMXDataController).handleLeftDividerDragged(
		...
		private function handleChange1(event:Event):void
		{
			...
			(_controller as PassiveSDMXDataController).handleRightDividerDragged(
				new DataEvent("test", false, false, "-1"));				
		}
		...
		private function handleChange2(event:Event):void
		{
			...
			(_controller as PassiveSDMXDataController).handleChartDragged(
				new DataEvent("test", false, false, "1"));			
		}
		...
		private function handleChange3(event:Event):void
		{
			...
			(_controller as PassiveSDMXDataController).handlePeriodChange(
