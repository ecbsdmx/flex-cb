package org.sdmx.stores.xml.v2
{
	...
	public class SDMXMLDaoFactoryTest extends TestCase
	{
		private var _factory:SDMXMLDaoFactory;
		
		private var _dataDao:IDataProvider;
		
		private var _dsds:KeyFamilies;
		
		public function SDMXMLDaoFactoryTest(methodName:String=null)
		{
			super(methodName);
		}
		...
		{
			return new TestSuite(SDMXMLDaoFactoryTest);
		}
		...
		{
			_dsds = event.data as KeyFamilies;
			_factory = new SDMXMLDaoFactory();
			_factory.sourceURL = new URLRequest("testData/usd.xml");
